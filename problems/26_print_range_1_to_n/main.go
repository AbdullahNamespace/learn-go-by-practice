// ════════════════════════════════════════════════════════════════════════════
// ## 🔷 Problem 26: print_range_1_to_n.go
// ════════════════════════════════════════════════════════════════════════════
...
// numbers from 1 to N using three different loop styles in Go:
...
// باستخدام ثلاثة أساليب مختلفة من الحلقات في Go:
// 1. حلقة for الكلاسيكية (بنمط C)
...
func main() {
	printResult(readPositiveNumber("Please enter number to print from 1 to it"))
}
