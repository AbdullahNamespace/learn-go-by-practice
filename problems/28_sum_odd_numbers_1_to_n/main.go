// ════════════════════════════════════════════════════════════════════════════
// ## 🔷 Problem 28: sum_odd_numbers_1_to_n.go
// ════════════════════════════════════════════════════════════════════════════
...
// the sum of all odd numbers from 1 to N using three different loop styles.
//
// AR:
...
// func sumOddUsingClassicFor(n int) int
// func sumOddUsingWhileStyle(n int) int
// func sumOddUsingInfiniteFor(n int) int
//
// ────────────────────────────────────────────────────────────────────────────
package main
...
func printResult(n int) {
	...
	fmt.Printf("%d\n", sumOddUsingWhileStyle(n))

	fmt.Print("3) Infinite For Loop : ")
	fmt.Printf("%d\n", sumOddUsingInfiniteFor(n))
}
